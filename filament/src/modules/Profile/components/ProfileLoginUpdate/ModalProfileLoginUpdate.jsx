...
import { useChangeLogin } from "../../hook/useChangeLogin";

const ModalProfileLoginUpdate = ({ open, handleClose }) => {
  const { register, handleSubmit } = useForm();

  const { mutate, error } = useChangeLogin(handleClose);
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(handleLoginUpdate)}>
        <Grid
          sx={{
            display: "flex",
            gap: "30px",
...
export default ModalProfileLoginUpdate;
