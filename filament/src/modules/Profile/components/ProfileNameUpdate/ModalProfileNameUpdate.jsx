...
import { useChangeName } from "../../hook/useChangeName";

const ModalProfileNameUpdate = ({ open, handleClose }) => {
  const { register, handleSubmit } = useForm();

  const { mutate, error } = useChangeName(handleClose);
...
export default ModalProfileNameUpdate;
